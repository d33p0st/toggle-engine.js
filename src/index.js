const enableDarkMode = (function() {
    return function checkDarkMode(startHour, startMinute, startSecond, endHour, endMinute, endSecond, refreshRate, optCallable=null, ...optArgs) {
        ...
        const timeToNumber = (h, m, s) => 3600 * h + 60 * m + s;
        ...
        // Schedule next check using named function for proper recursion
        setTimeout(() => checkDarkMode(startHour, startMinute, startSecond, endHour, endMinute, endSecond, refreshRate, optCallable, ...optArgs), refreshRate);
    };
})();
