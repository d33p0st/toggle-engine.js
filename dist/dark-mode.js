...
function enableDarkMode(startHour, startMinute, startSecond, endHour, endMinute, endSecond, refreshRate, optCallable = null, ...optArgs) {
  ...
  if (startHour < endHour) {
    ...
    isDarkMode = currentHour > startHour && currentHour < endHour || currentHour === startHour && (currentMinute > startMinute || currentMinute === startMinute && currentSecond >= startSecond) || currentHour === endHour && (currentMinute < endMinute || currentMinute === endMinute && currentSecond < endSecond);
    ...
    if (startMinute < endMinute) {
      isDarkMode = currentHour === startHour && (currentMinute > startMinute && currentMinute < endMinute || currentMinute === startMinute && currentSecond >= startSecond || currentMinute === endMinute && currentSecond < endSecond);
    } else if (startMinute > endMinute) {
      isDarkMode = currentHour === startHour && (currentMinute > startMinute || currentMinute < endMinute || currentMinute === startMinute && currentSecond >= startSecond || currentMinute === endMinute && currentSecond < endSecond);
    } else {
      // Same minute: just compare seconds
      isDarkMode = currentHour === startHour && currentMinute === startMinute && currentSecond >= startSecond && currentSecond < endSecond;
    }
  }
  if (isDarkMode) {
    // dark mode here
